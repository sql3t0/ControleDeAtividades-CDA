...
<body>
	<div class="container-fluid">
		<div class="row">
			<div class="container-fluid container_black_trans" id="topo">
				<div class="row">
					<div class="col-md-2">
					...
					<div class="col-2">
						<div class="container_black_trans" id="menu">
							...
							<?php 
								...
								<a href="paginas/Usuario.php" target="frame_central"><button id="botoes" class="btn btn-default botoes box3D" type="submit" title="Gerenciar Usuarios" ><img style="float: left;" src="imagens/add_user.png"/>Usuários</button></a><br>
								...
								<a href="paginas/tarefa_view.php" target="frame_central"><button id="botoes" class="btn btn-default botoes box3D" type="submit" title="Tarefas em Aberto" autofocus ><img style="float: left;" src="imagens/opened_task.png"/>Tarefas</button></a>
								...
								<a href="paginas/relatorio.php" target="frame_central"><button id="botoes" class="btn btn-default botoes box3D" type="submit" title="Gerenciar Relatorios" ><img style="float: left;" src="imagens/report.png"/>Relatório</button></a>
								<?php }else{ ?>
												<a href="paginas/tarefa_view.php" target="frame_central"><button id="botoes" class="btn btn-default botoes box3D" type="submit" title="Tarefas em Aberto" autofocus ><img style="float: left;" src="imagens/opened_task.png"/>Tarefas</button></a>
												<a href="paginas/tarefa_finalizada.php" target="frame_central"><button id="botoes" class="btn btn-default botoes box3D" type="submit" title="Tarefas Finalizadas" ><img style="float: left;" src="imagens/closed_task.png"/>Tarefas</button></a>
									  <?php }?>	
		...
		<div class="container-fluid container_black_trans" id="rodape">

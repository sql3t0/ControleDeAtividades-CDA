						...
						<form name="formulario" class="form-group">
							<table class="table table-striped table-inverse" id="minhaTabela">
								<thead class="thead-inverse">   
									<tr id="tr_filtro">
										<th><img src="../imagens/filter.png" title="Limpar Filtros de Pesquisa" class="cls_filtro box3D" /></th>
								...
								<tbody>
									<?php
									if($nivel == 2){//eh admin
										$res = mysqli_query($con,"select * from tarefa where setor = '$setor' AND status = '0' order by id desc LIMIT 600");
									}else{//comun user
											...
											if($_SESSION['usuarioNivel'] == 2){
												...
												if($status == 0 ){
													if($status_time == 0){
														...
														echo "<td ><button type=\"button\" id=\"bt_modal_pause_$idLinha\" class=\"btn btn-primary box3D buttons_trs\" data-toggle=\"modal\" data-target=\"#exampleModal_pause_$idLinha\" title=\" Pausar Tarefa\" > <img src=\"..\imagens\pause.png\" alt=\"Pausar Tarefa\" /> </button><div class=\"modal fade\" id=\"exampleModal_pause_$idLinha\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\"> <div class=\"modal-dialog\" role=\"document\"> <div class=\"modal-content bt_excluir\"> <div class=\"modal-header\"> <h5 class=\"modal-title\" id=\"exampleModalLabel_pause\">Pausar Tarefa</h5> <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"> <span aria-hidden=\"true\">&times;</span> </button> </div> <div class=\"modal-body\"> Deseja Pausar essa Tarefa ? </div> <div class=\"modal-footer\"> <button type=\"button\" class=\"btn btn-secondary box3D\" data-dismiss=\"modal\" >Cancelar</button> <button type=\"button\" id=\"bt_pausar_$idLinha\" class=\"btn btn-secondary box3D bg_bt_excluir\" data-dismiss=\"modal\" onclick=\"ControlTimer('pause_time',$codigo,'$usuario');\" >Pausar</button> </div> </div> </div> </div></td>";

								...
								<table class="table table-striped table-inverse" id="minhaTabela">
									<thead class="thead-inverse">
										<tr id="tr_filtro">
											...
											<th><input type="text" class="form-control th_filtro" placeholder="Nome" title="Insira um valor e tecle [ENTER]" aria-label="Nome" id="txtColuna1"/></th>
											<th class="th_filtro" style="display:none;"></th>
											<th><input type="text" class="form-control th_filtro" placeholder="Empresa" title="Insira um valor e tecle [ENTER]" aria-label="Empresa" id="txtColuna3"/></th>
											<th><input type="text" class="form-control th_filtro" placeholder="Atividade" title="Insira um valor e tecle [ENTER]" aria-label="Atividade" id="txtColuna4"/></th>
											<th><input type="text" class="form-control th_filtro" placeholder="Data Ini" title="Insira um valor e tecle [ENTER]" aria-label="Data inicio" id="txtColuna5"/></th>
											<th><input type="text" class="form-control th_filtro" placeholder="Data Fim" title="Insira um valor e tecle [ENTER]" aria-label="Data fim" id="txtColuna6"/></th>
											<th><input type="text" class="form-control th_filtro" placeholder="Obs" title="Insira um valor e tecle [ENTER]" aria-label="Observacao" id="txtColuna7"/></th>
											<th><img src="../imagens/filter.png" title="Filtros de Pesquisa" /></th>
										</tr>
										<tr>
											<th id="codigo" class="tb_cabecalho" style="display:none;" ><strong>Código</strong></th>
											...
											<th id="data_ini" class="tb_cabecalho"><strong>Data de Início</strong></th>
											<th id="data_fim" class="tb_cabecalho"><strong>Data de Finalizacao</strong></th>
											<th id="obs" class="tb_cabecalho"><strong>Observação</strong></th>
											<th id="iniciar" class="tb_cabecalho"><strong>&nbsp;</strong></th>
										</tr>
									</thead>
									<tbody>
										<?php
										if($nivel == 2){//eh admin
											$res = mysqli_query($con,"select * from tarefa where setor = '$setor' AND status = '1' order by id desc limit 800");
										}else{//comun user
											$res = mysqli_query($con,"select * from tarefa where setor = '$setor' and usuario = '$username' AND status = '1' order by id desc limit 250");
										}
										...
										if ($total > 0){
											for($i=0; $i<$total; $i++){
												...
												$data_fim = date('d/m/Y', strtotime($dados[6]));
												$obs = $dados[7];
												$status = $dados[8];
												$status_time = $dados[9];
												...
												if($_SESSION['usuarioNivel'] == 2){
													if($status_time == 0){
														echo "<td ><button type=\"button\" id=\"bt_modal_$idLinha\" class=\"btn btn-primary box3D buttons_trs\" data-toggle=\"modal\" data-target=\"#exampleModal_$idLinha\" title=\"Excluir Tarefa\" ><img src=\"..\imagens\delete.png\" alt=\" Excluir Tarefa\" /></button><div class=\"modal fade\" id=\"exampleModal_$idLinha\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\"> <div class=\"modal-dialog\" role=\"document\"> <div class=\"modal-content bt_excluir\"> <div class=\"modal-header\"> <h5 class=\"modal-title\" id=\"exampleModalLabel\">Excluir item</h5> <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"> <span aria-hidden=\"true\">&times;</span> </button> </div> <div class=\"modal-body\"> Deseja excluir o item ? </div> <div class=\"modal-footer\"> <button type=\"button\" class=\"btn btn-secondary box3D\" data-dismiss=\"modal\" >Cancelar</button> <button type=\"button\" id=\"bt_excluir_$idLinha\" class=\"btn btn-secondary box3D bg_bt_excluir\" data-dismiss=\"modal\" onclick=\"ExcluirLinha('$idLinha', '$codigo','tarefa');\" >Excluir</button> </div> </div> </div> </div></td>";
													}else{
														if($status == 0 ){
															echo "<td ><button type=\"button\" id=\"bt_modal_$idLinha\" class=\"btn btn-primary box3D buttons_trs\" data-toggle=\"modal\" data-target=\"#exampleModal_$idLinha\" title=\" Tarefa em Andamento\" disabled> <img src=\"..\imagens\started.png\" alt=\"Tarefa em Andamento\" /> </button> ";
														}else{
															echo "<td ><button type=\"button\" id=\"bt_modal_$idLinha\" class=\"btn btn-primary box3D buttons_trs\" data-toggle=\"modal\" data-target=\"#opentask_$idLinha\" title=\" Reabrir Tarefa\"> <img src=\"..\imagens\check.png\" alt=\" Tarefa Finalizada\" /> </button> <div class=\"modal fade\" id=\"opentask_$idLinha\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"opentask_$idLinha\" aria-hidden=\"true\"> <div class=\"modal-dialog\" role=\"document\"> <div class=\"modal-content bt_excluir\"> <div class=\"modal-header\"> <h5 class=\"modal-title\" id=\"opentask_$idLinha\">Reabrir Tarefa</h5> <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"> <span aria-hidden=\"true\">&times;</span> </button> </div> <div class=\"modal-body\"> Deseja reabrir esta tarefa ? </div> <div class=\"modal-footer\"> <button type=\"button\" class=\"btn btn-secondary box3D\" data-dismiss=\"modal\" >Cancelar</button> <button type=\"button\" id=\"bt_excluir_$idLinha\" class=\"btn btn-secondary box3D bg_bt_excluir\" data-dismiss=\"modal\" onclick=\"reabrirTarefa('$codigo','tarefa');\" >Reabrir</button> </div> </div> </div> </div></td>";
														}
													}
													...
													if($status == 0 ){
														...
														echo "<td ><button type=\"button\" id=\"bt_modal_$idLinha\" class=\"btn btn-primary box3D buttons_trs\" data-toggle=\"modal\" data-target=\"#exampleModal_$idLinha\" title=\" Tarefa Finalizada\" disabled> <img src=\"..\imagens\check.png\" alt=\" Tarefa Finalizada\" />  </button>";
													}
												}
											...
											echo "<tr><td></td><td></td><td></td><td align=\"center\" >Nenhum registro de Tarefa Encontrado</td><td align=\"center\"> <img src=\"..\imagens\_empty.png\" alt=\"Nenhum registro de Tarefa\" /> </td><td></td><td></td><td></td></tr>";
										}
										?>
